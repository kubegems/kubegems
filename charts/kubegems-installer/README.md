...
| `installer.startupProbe.enabled`                  | Enable startupProbe on %%MAIN_CONTAINER_NAME%% containers                                             | `false`             |
...
| `installer.priorityClassName`                     | %%MAIN_CONTAINER_NAME%% pods' priorityClassName                                                       | `""`                |
