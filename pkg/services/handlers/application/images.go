...
// @Security JWT
func (h *ImageHandler) Vulnerabilities(req *restful.Request, resp *restful.Response) {
	...
	h.OnHarborFunc(req, resp, onharborfunc, ocifunc)
}
...
// @Security JWT
func (h *ImageHandler) Summary(req *restful.Request, resp *restful.Response) {
	onharborfunc := func(ctx context.Context, cli *harbor.Client, image string) (interface{}, error) {
		...
		paged := handlers.NewPageDataFromContext(req, summaries, nil, nil)
		return paged, nil
	}

	ocifunc := func(_ context.Context, _ *harbor.OCIDistributionClient, _ string) (interface{}, error) {
		summaries := []ImageSummaryItem{}
		return handlers.NewPageDataFromContext(req, summaries, nil, nil), nil
	}
...
// @Security JWT
func (h *ImageHandler) Unpublishable(req *restful.Request, resp *restful.Response) {
	onharborfunc := func(ctx context.Context, cli *harbor.Client, image string) (interface{}, error) {
		isunpublishable, _ := strconv.ParseBool(req.QueryParameter("unpublishable"))
		if isunpublishable {
...
// @Security JWT
func (h *ImageHandler) Scan(req *restful.Request, resp *restful.Response) {
	onharborfunc := func(ctx context.Context, cli *harbor.Client, image string) (interface{}, error) {
...
// @Security JWT
func (h *ImageHandler) ImageTags(req *restful.Request, resp *restful.Response) {
	...
	h.OnHarborFunc(req, resp, harborfunc, ocifunc)
}
...
func (h *ImageHandler) OnHarborFunc(req *restful.Request, resp *restful.Response, harborfun HarborFunc, ocifunc OCIFunc) {
	process := func(ctx context.Context) (interface{}, error) {
		...
		_ = h.completeRegistryOption(ctx, options, image, tenant, project) // ignore
	...
	if data, err := process(req.Request.Context()); err != nil {
...
func (h *ImageHandler) completeRegistryOption(ctx context.Context, options *RegistryOptions, imgname string, tenant, project string) error {
