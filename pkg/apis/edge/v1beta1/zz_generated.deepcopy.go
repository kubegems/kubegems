...
func (in *EdgeTaskPodStatus) DeepCopyInto(out *EdgeTaskPodStatus) {
	*out = *in
	...
	if in.Events != nil {
		...
		*out = make([]EdgeTaskResourceEvent, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EdgeTaskResourceEvent) DeepCopy() *EdgeTaskResourceEvent {
	if in == nil {
		return nil
	}
	out := new(EdgeTaskResourceEvent)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EdgeTaskResourceStatus) DeepCopyInto(out *EdgeTaskResourceStatus) {
	*out = *in
	...
	if in.PodsStatus != nil {
		...
		*out = make([]EdgeTaskPodStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EdgeTaskResourceStatus) DeepCopy() *EdgeTaskResourceStatus {
	if in == nil {
		return nil
	}
	out := new(EdgeTaskResourceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EdgeTaskStatus) DeepCopyInto(out *EdgeTaskStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]EdgeTaskCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ResourcesStatus != nil {
		...
		*out = make([]EdgeTaskResourceStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
