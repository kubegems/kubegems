...
func (h *LogOperatorHandler) RegistRouter(rg *gin.RouterGroup) {
	...
	rg.GET("/logging/cluster/:cluster/tenant/:tenant_id/flows", h.CheckByTenantID, h.Flows)
	rg.GET("/logging/cluster/:cluster/tenant/:tenant_id/outputs", h.CheckByTenantID, h.Outputs)
