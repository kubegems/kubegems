...
// +gen type:object pkcolume:id pkfield:ID preloads:Tenant
type Project struct {
...
// ProjectUserRels 项目用户关联关系表
// +gen type:objectrel pkcolume:id pkfield:ID preloads:User,Project leftfield:User rightfield:Project
